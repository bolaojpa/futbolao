...
export const predefinedTeams: Omit<Team, 'id'>[] = [
  ...
  { name: 'Slavia Praha', type: 'club', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/9/91/SK_Slavia_Praha_logo.svg/1200px-SK_Slavia_Praha_logo.svg.png', countryOrConfederation: 'UEFA / Czech Republic', league: 'Czech First League' },
  { name: 'Pafos FC', type: 'club', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/0/03/Pafos_FC_logo.svg/1200px-Pafos_FC_logo.svg.png', countryOrConfederation: 'UEFA / Cyprus', league: 'Cypriot First Division' },
  { name: 'FK Bodø/Glimt', type: 'club', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/f/f3/FK_Bod%C3%B8-Glimt_logo.svg/1200px-FK_Bod%C3%B8-Glimt_logo.svg.png', countryOrConfederation: 'UEFA / Norway', league: 'Eliteserien' },
  { name: 'Qarabağ FK', type: 'club', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/a/ab/Qaraba%C4%9F_FK_logo.svg/1200px-Qaraba%C4%9F_FK_logo.svg.png', countryOrConfederation: 'UEFA / Azerbaijan', league: 'Azerbaijan Premier League' },
  { name: 'FC Copenhagen', type: 'club', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/9/9f/F.C._Copenhagen_logo.svg/1200px-F.C._Copenhagen_logo.svg.png', countryOrConfederation: 'UEFA / Denmark', league: 'Danish Superliga' },
  ...
  { name: 'Poland', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Herb_Polski.svg/1200px-Herb_Polski.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Czech Republic', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Coat_of_arms_of_the_Czech_Republic.svg/1200px-Coat_of_arms_of_the_Czech_Republic.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Slovakia', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Coat_of_arms_of_Slovakia.svg/1200px-Coat_of_arms_of_Slovakia.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Slovenia', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Coat_of_arms_of_Slovenia.svg/1200px-Coat_of_arms_of_Slovenia.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Hungary', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Coat_of_arms_of_Hungary.svg/1200px-Coat_of_arms_of_Hungary.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Romania', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Coat_of_arms_of_Romania.svg/1200px-Coat_of_arms_of_Romania.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Bulgaria', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Coat_of_arms_of_Bulgaria.svg/1200px-Coat_of_arms_of_Bulgaria.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Serbia', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Coat_of_arms_of_Serbia.svg/1200px-Coat_of_arms_of_Serbia.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Bosnia and Herzegovina', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Coat_of_arms_of_Bosnia_and_Herzegovina.svg/1200px-Coat_of_arms_of_Bosnia_and_Herzegovina.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'North Macedonia', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Coat_of_arms_of_North_Macedonia.svg/1200px-Coat_of_arms_of_North_Macedonia.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Albania', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Coat_of_arms_of_Albania.svg/1200px-Coat_of_arms_of_Albania.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Scotland', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/1/10/Scottish_Football_Association_logo.svg/1200px-Scottish_Football_Association_logo.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Republic of Ireland', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/f/f3/Republic_of_Ireland_national_football_team_logo.svg/1200px-Republic_of_Ireland_national_football_team_logo.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Northern Ireland', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/3/36/Irish_Football_Association_logo.svg/1200px-Irish_Football_Association_logo.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Wales', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/d/de/Football_Association_of_Wales_logo.svg/1200px-Football_Association_of_Wales_logo.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Finland', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/8/8b/Football_Association_of_Finland_logo.svg/1200px-Football_Association_of_Finland_logo.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Iceland', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/5/5f/Football_Association_of_Iceland_logo.svg/1200px-Football_Association_of_Iceland_logo.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Turkey', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/a/ae/TFF_logo.svg/1200px-TFF_logo.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Greece', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/8/86/Hellenic_Football_Federation_logo.svg/1200px-Hellenic_Football_Federation_logo.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Georgia', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/1/14/Georgian_Football_Federation_logo.svg/1200px-Georgian_Football_Federation_logo.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Russia', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/e/e3/Russian_Football_Union_logo.svg/1200px-Russian_Football_Union_logo.svg.png', countryOrConfederation: 'UEFA' },
  { name: 'Ukraine', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/8/8d/Ukrainian_Association_of_Football_logo.svg/1200px-Ukrainian_Association_of_Football_logo.svg.png', countryOrConfederation: 'UEFA' },

  // CONMEBOL
  { name: 'Brazil', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/9/99/Brazilian_Football_Confederation_logo.svg/1200px-Brazilian_Football_Confederation_logo.svg.png', countryOrConfederation: 'CONMEBOL' },
  { name: 'Argentina', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/c/c1/Argentine_Football_Association_logo.svg/1200px-Argentine_Football_Association_logo.svg.png', countryOrConfederation: 'CONMEBOL' },
  { name: 'Uruguay', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/c/ce/Uruguayan_Football_Association_logo.svg/1200px-Uruguayan_Football_Association_logo.svg.png', countryOrConfederation: 'CONMEBOL' },
  { name: 'Chile', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/5/5a/Federaci%C3%B3n_de_F%C3%BAtbol_de_Chile_logo.svg/1200px-Federaci%C3%B3n_de_F%C3%BAtbol_de_Chile_logo.svg.png', countryOrConfederation: 'CONMEBOL' },
  { name: 'Paraguay', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/8/88/Paraguayan_Football_Association_logo.svg/1200px-Paraguayan_Football_Association_logo.svg.png', countryOrConfederation: 'CONMEBOL' },
  { name: 'Colombia', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/2/21/Colombian_Football_Federation_logo.svg/1200px-Colombian_Football_Federation_logo.svg.png', countryOrConfederation: 'CONMEBOL' },
  { name: 'Ecuador', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/a/a4/Ecuadorian_Football_Federation_logo.svg/1200px-Ecuadorian_Football_Federation_logo.svg.png', countryOrConfederation: 'CONMEBOL' },
  { name: 'Peru', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/5/52/Peruvian_Football_Federation_logo.svg/1200px-Peruvian_Football_Federation_logo.svg.png', countryOrConfederation: 'CONMEBOL' },
  { name: 'Bolivia', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/c/c4/Bolivian_Football_Federation_logo.svg/1200px-Bolivian_Football_Federation_logo.svg.png', countryOrConfederation: 'CONMEBOL' },
  { name: 'Venezuela', type: 'national', crestUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/4/41/Venezuelan_Football_Federation_logo.svg/1200px-Venezuelan_Football_Federation_logo.svg.png', countryOrConfederation: 'CONMEBOL' },
