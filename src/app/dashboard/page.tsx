                                                                ...
                                                                <div className="flex items-center justify-center w-full">
                                                                    <div className='flex-1 flex flex-row items-center justify-end gap-3'>
                                                                        ...
                                                                        <div className='h-12 w-14 flex items-center justify-center'>
                                                                            <Image src={teamA?.crestUrl || "https://picsum.photos/128/128"} alt="" width={56} height={56} className="object-contain h-auto" data-ai-hint="team logo" />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className='flex-1 flex flex-row items-center justify-start gap-3'>
                                                                        <div className='h-12 w-14 flex items-center justify-center'>
                                                                            <Image src={teamB?.crestUrl || "https://picsum.photos/128/128"} alt="" width={56} height={56} className="object-contain h-auto" data-ai-hint="team logo" />
                                                                        </div>
