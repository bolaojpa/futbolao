...
export default function DashboardPage() {
    ...
    const getChampionPickWinner = useMemo(() => {
        ...
        return (championship: Championship) => {
            ...
            // Simplified: for display purposes, we just need to know the winning tier
            const winningTeam = finalRankingOrder[bestTier.rank];
            // In a real scenario with multiple winners, this would need more complex logic.
            // For now, we'll just say the first contender found holds the winning tier.
                                                                                                ...
                                                                                                if (winnerInfo) {
                                                                                                    if (user.id !== winnerInfo.winnerId || (user.id === winnerInfo.winnerId && teamName !== winnerInfo.winningTeam)) {
                                                                                                        if (userBestPickRank === undefined || userBestPickRank > winnerBestPickRank) {
                                                                                                            isEliminated = true;
                                                                                                        } else if (userBestPickRank === winnerBestPickRank) {
                                                                                                            // This is a tie, handle sub-logic later if needed. For now, assume color.
                                                                                                        }
                                                                                                    }
                                                                                                } else {
                                                                                                    isEliminated = true;
